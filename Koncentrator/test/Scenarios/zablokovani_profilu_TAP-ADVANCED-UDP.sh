...
curl -f -v -X POST "http://127.0.0.1:10002/blockprofile" --data '{"subvpn_name" : "tap-advanced-12345", "subvpn_type" : "tap-advanced", "common_name" : "test-hash-1111"}' -o profile.json
